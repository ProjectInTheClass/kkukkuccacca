...
class CafeListViewController: UIViewController,UITableViewDataSource, UITableViewDelegate {
    ...
    var items = [
        Cafe (cafeNames: "트리아농",cafeImages: "image_cafe1",
        ...
        Cafe (cafeNames: "알베르",cafeImages: "image_cafe1",
        ...
        Cafe (cafeNames: "이디야커피랩",cafeImages: "image_cafe1",
        ...
        Cafe (cafeNames: "오아시스",cafeImages: "image_cafe1",
        ...
        Cafe (cafeNames: "미엘",cafeImages: "image_cafe1",
