...
//
    ...
    func tableView(_ tableView: UITableView, numberOfRowsInSection section: Int) -> Int {
        if 0 == section {
            ...
            return itemt!.menu[1].count
        } else {
            return itemt!.menu[2].count
        }
    }
...
//        ]
        ...
        func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
            ...
            cell.pictureimageview.image = itemt!.signature.picture
            cell.namelabel.text = itemt!.signature.name
            cell.pricelabel.text = itemt!.signature.price
